...
export const SLIDES: SlideDefinition[] = [
  ...
  },
  {
    ...
    steps: 4,
    notes: 'Here is how a copywriter and a data analyst both succeed in the same module. Because the cohort is genuinely mixed, the module runs two learning paths over one shared backbone. \n- The Communication & Design path — Copy & Story and Design & Arts — works low-code, AI-assisted, and focuses on interpreting, critiquing, visualizing, and explaining the evidence. \n- The Data & Analytics path — Media & Data and anyone quantitatively inclined — works in notebooks and the Python ecosystem and goes deeper: reproduce, extend, model, validate. \n- Crucially, the paths are not two different courses. Same dataset, same research question, same evidence standards, same competencies — different tool depth, identical cognitive standard. A student is assessed on the quality of their reasoning and the defensibility of their decision, not on how much code they wrote. This is what makes a Data Science module honest for students who have never programmed.',
  },
  {
  ...
  },
  {
    ...
    steps: 4,
    notes: 'Sixteen hours on-site is precious. I use them for what asynchronous formats and AI avatars cannot do: collaborative model evaluation with real-time methodological critique, peer review, and judgment discussions that only work face-to-face. By Week 4, students have framed the problem, explored the data, and worked through statistical reasoning — the on-site phase is where they integrate everything into a defended workflow. \n- Day 1 is hands-on and team-based — a dataset walkthrough, collaborative model evaluation and error analysis, with each team documenting one concrete failure mode or bias risk. \n- Day 2 allows for peer review across teams and closes with a live presentation of the recommendation to a non-technical audience — the final stage of the Analyze → Model → Critique → Defend arc. How is everything assessed?',
  },
  {
    ...
    steps: 8,
    notes: 'How is competence assured when students have free access to AI? AI is allowed where professional judgment is assessed, restricted where personal competence must be verified. \n- The dual-lane approach follows Fawns et al. (2025): The live defense is the assured instrument you just saw at the close of the Studio: \n- in-person, unaided, students answer methodological questions from a non-technical audience and own the limits of their analysis. \n- The integrated Lane are digital hand-ins. \n- Four artefacts trace the weekly arc — Week 2 data audit + EDA notebook, Week 3 statistical reasoning brief, Week 4 live defense, Week 5 final data story.  The digital submisions may use AI — but AI use must be documented and reflected on. This is not an AI-ban policy; it is an AI-honest one.',
  },
  {
    id: 'why-this-works',
    part: 'teaching',
